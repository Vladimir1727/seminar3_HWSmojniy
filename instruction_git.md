...
### Связывания локального репозитория

Для этого необходимо зарегистрироваться на GitHub и создать репозиторий на сайте. Далее с помощью трех команд которые вы выполняете в терминале GitHub связывает онлайн репозиторий с вашим устройством. 

## Коанды связанные с удаленным репозиторием

    git push

Отправляет на сервер файлы, которые были добавлены в индекс

    git pull

Скачиваем файлы из другого репозитория.
...
Это заявка на слияние кода из разных веток

    fork

Это создание собственное ответвление

# Спасибо за начальные знания